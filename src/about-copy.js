export const ABOUT_COPY = {
  es: {
    intro: "Laboratorio de software. Tres líneas de trabajo con código ejecutable y evidencia pública.",
    lines: "El sitio muestra qué corre hoy y qué se está construyendo después.",
    ...
    echoai: "agente situado de dos relojes. ECHO-1 y ECHO-2 están cerrados. El núcleo rápido ve, recuerda, predice, actúa y aprende; el lento sólo propone. ECHO-2 añade supervivencia, patrones, streaming, consolidación, herencia, energía y temperatura, con un monitor de 512 LIF + 128 Adaptive-LIF. ECHO-3 llevará estos contratos a tres mundos físicos simulados, PX4 y después hardware real.",
  },
  en: {
    intro: "A software laboratory. Three lines of work with executable code and public evidence.",
    lines: "The site shows what runs today and what is being built next.",
    ...
    echoai: "two-clock situated agent. ECHO-1 and ECHO-2 are closed. The fast core sees, remembers, predicts, acts and learns; the slow clock only proposes. ECHO-2 adds survival, patterns, streaming, consolidation, inheritance, energy and temperature, with a 512 LIF + 128 Adaptive-LIF monitor. ECHO-3 will carry these contracts into three simulated physical worlds, PX4 and then real hardware.",
  },
  ca: {
    intro: "Laboratori de programari. Tres línies de treball amb codi executable i evidència pública.",
    lines: "El lloc mostra què s'executa avui i què es construeix després.",
    ...
    echoai: "agent situat de dos rellotges. ECHO-1 i ECHO-2 estan tancats. El nucli ràpid veu, recorda, prediu, actua i aprèn; el lent només proposa. ECHO-2 afegeix supervivència, patrons, streaming, consolidació, herència, energia i temperatura, amb un monitor de 512 LIF + 128 Adaptive-LIF. ECHO-3 portarà aquests contractes a tres mons físics simulats, PX4 i després maquinari real.",
  },
};
