  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/releases" element={<Navigate to="/echoai#release" replace />} />
        <Route path="/en/releases" element={<Navigate to="/en/echoai#release" replace />} />
        <Route path="/ca/releases" element={<Navigate to="/ca/echoai#release" replace />} />
