# ECHO-3: thirteen green phases and two open questions
...
The current question is which reusable knowledge improves a decision. Q, cost and gain trials separated learning, influence over the planner and usefulness. They also withdrew explanations rejected by controls, such as keeping longer plans being enough to solve transfer.
...
## Sources and verifiable state

The roadmap and downloadable reports preserve each phase's scope. The data snapshot identifies source files and hashes. All 261 TRANSFER-3 regression tests pass; the global suite remains unverified because of its historical memory limitation.

[Roadmap](/en/docs/echoai/ruta) · [TRANSFER-3 research](/en/articulos/transfer3-aprender-no-basta) · [Data and source reports](/data/echo3-status.json)
