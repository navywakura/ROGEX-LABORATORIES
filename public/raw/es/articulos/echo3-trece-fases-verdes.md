# ECHO-3: trece fases verdes y dos preguntas abiertas

18 de septiembre de 2026 · RxLabs®

> Archivo del 18/09/2026. El estado actual es 14/15 certificados software, TRANSFER-3 verde y DRONE-3 con su tramo SITL cerrado. [Actualización del 20/09](/articulos/drone3-mision-integrada-sitl).
...
La pregunta actual es qué conocimiento reutilizable produce una decisión mejor. Los ensayos de Q, coste y ganancia separaron aprendizaje, influencia sobre el planificador y utilidad. También retiraron explicaciones que los controles refutaron, como que conservar planes largos solucionaría por sí solo la transferencia.
...
La hoja de ruta y los informes descargables conservan el alcance de cada fase. La instantánea de datos identifica sus fuentes y hashes. La regresión TRANSFER-3 pasa 261 tests; la suite global no se declara verificada por su limitación histórica de memoria.

[Hoja de ruta](/docs/echoai/ruta) · [Investigación TRANSFER-3](/articulos/transfer3-aprender-no-basta) · [Datos e informes de origen](/data/echo3-status.json)
